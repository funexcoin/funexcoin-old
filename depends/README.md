...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_funexcoin` executable (see https://github.com/funexcoin/funexcoin/pull/13543),
...
options will be passed to funexcoin's configure. In this case, `--disable-wallet`.
