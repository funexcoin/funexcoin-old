Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/funexcoin/files/Bitcoin/funexcoin-0.7.0/

We recommend that everybody running prior versions of funexcoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/funexcoin/funexcoin/tarball/v0.7.0  # .tar.gz
  https://github.com/funexcoin/funexcoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the funexcoin-qt package:
  sudo apt-get install funexcoin-qt
...
Core funexcoin handling and blockchain database
...
* Ensure a changed funexcoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for funexcoin-qt.exe
* (Windows only): add meta-data to funexcoin-qt.exe (e.g. description)
...
* Bash programmable completion for funexcoind(1)
