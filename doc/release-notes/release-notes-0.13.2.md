Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://funexcoin.org/bin/funexcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update funexcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow funexcoin-tx to create v2 transactions (BTCdrak)
