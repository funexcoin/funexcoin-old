Bitcoin Core version 0.19.0.1 is now available from:
  ...
  <https://funexcoincore.org/bin/funexcoin-core-0.19.0.1/>
...
- [Reduce memory](https://github.com/funexcoin/funexcoin/blob/master/doc/reduce-memory.md)
...
- `whitebind` and `whitelist` now accept a list of permissions to
  ...
  releases.  See the `funexcoind -help` output for these two options for
...
- The `testnet` field in `funexcoin-cli -getinfo` has been renamed to
...
- Transactions with outputs paying v1 to v16 witness versions (future
  ...
  and services can accept any valid bech32 FunexCoin address without
...
- #17449 fix uninitialized variable nMinerConfirmationWindow (funexcoinVBR)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/funexcoin/funexcoin/).
