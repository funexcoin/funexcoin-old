Bitcoin Core version 0.10.4 is now available from:
  ...
  <https://funexcoin.org/bin/funexcoin-core-0.10.4/>
...
- #6953 `43c2789` Split funexcoin-tx into its own package
- #6953 `dfe0d4d` Include funexcoin-tx binary on Debian/Ubuntu
