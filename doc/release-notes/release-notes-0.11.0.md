Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://funexcoin.org/bin/funexcoin-core-0.11.0/>
...
For example, add the following to `funexcoin.conf`:
...
related to the blockchain in the funexcoin system: the raw blocks as received over 
...
For an example script see [funexcoin-submittx](https://github.com/laanwj/funexcoin-submittx).
...
- #5334 `cf87536` libfunexcoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new funexcoin-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add funexcoin logo to about screen
...
- #5809 `46bfbe7` Add funexcoin-cli man page
...
- #5849 `41259ca` contrib/init/funexcoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for funexcoin-tx)
