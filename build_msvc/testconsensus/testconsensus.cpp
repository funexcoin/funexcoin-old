...
// funexcoin includes.
#include <..\src\script\funexcoinconsensus.h>
...
int main()
{
    std::cout << "funexcoinconsensus version: " << funexcoinconsensus_version() << std::endl;
    ...
    auto op0Result = funexcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, funexcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
