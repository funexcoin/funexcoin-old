...
#include <qt/funexcoingui.h>

#include <qt/funexcoinunits.h>
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FunexCoin address"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FunexCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FunexCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a funexcoin: URI"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to FunexCoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
