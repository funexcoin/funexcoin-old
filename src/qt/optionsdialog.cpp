    ...
    mapper(nullptr)
{
    ...
    ui->funexcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->funexcoinAtStartup);
    ...
    ui->funexcoinAtStartup->setToolTip(ui->funexcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->funexcoinAtStartup->setText(ui->funexcoinAtStartup->text().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->funexcoinAtStartup, OptionsModel::StartAtStartup);
