...
const char * const BITCOIN_CONF_FILENAME = "funexcoin.conf";
 ...
 * https://github.com/funexcoin/funexcoin/pull/16097#issuecomment-514627823
 */
...
bool ArgsManager::ParseParameters(int argc, const char* const argv[], std::string& error)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (key == "-") break; //funexcoin-tx using stdin
        std::string val;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/FunexCoin";
#else
    // Unix
