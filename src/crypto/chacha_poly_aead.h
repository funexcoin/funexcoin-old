...
/* A AEAD class for ChaCha20-Poly1305@funexcoin.
 *
 ...
 *
 * The chacha20-poly1305@funexcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@funexcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@funexcoin are relatively fast in
