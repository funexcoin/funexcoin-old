...
class BackwardsCompatibilityTest(BitcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        self.add_nodes(self.num_nodes, extra_args=self.extra_args, versions=[
            ...
            self.options.funexcoind,
            self.options.funexcoind,
            releases_path + "/v0.19.0.1/bin/funexcoind",
            releases_path + "/v0.18.1/bin/funexcoind",
            releases_path + "/v0.17.1/bin/funexcoind"
        ], binary_cli=[
            self.options.funexcoincli,
            self.options.funexcoincli,
            releases_path + "/v0.19.0.1/bin/funexcoin-cli",
            releases_path + "/v0.18.1/bin/funexcoin-cli",
            releases_path + "/v0.17.1/bin/funexcoin-cli"
        ])
    ...
    def run_test(self):
        ...
        # RPC loadwallet failure causes funexcoind to exit, in addition to the RPC
