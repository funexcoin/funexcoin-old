...
"""Verify that starting funexcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start funexcoin with -h for help text")
        ...
        self.log.info("Start funexcoin with -version for version information")
        ...
        self.log.info("Start funexcoind with -fakearg to make sure it does not start")
