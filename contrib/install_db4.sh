...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the funexcoin repository."
  exit 1
fi
...
# See https://github.com/funexcoin/funexcoin/issues/16064
...
echo 'When compiling funexcoind, run `./configure` in the following way:'
echo
