...
(define* (make-funexcoin-cross-toolchain target
                                  #:key
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-funexcoin-cross-toolchain "i686-linux-gnu")
       (make-funexcoin-cross-toolchain "x86_64-linux-gnu")
       (make-funexcoin-cross-toolchain "aarch64-linux-gnu")
       (make-funexcoin-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-funexcoin-cross-toolchain "riscv64-linux-gnu"
